...
class _HomePageState extends State<HomePage> {
  ...
  Widget getBody(){
    ...
    return ListView(
      ...
      children: <Widget>[
        Text("سالادهای خوشمزه",style: TextStyle(
          fontSize: 20,
          fontWeight: FontWeight.bold,
        ),),
        SizedBox(height: 10,),
        Text("از ما غذای تازه و سالم بخواهید",style: TextStyle(
          fontSize: 14,
          fontFamily: 'Vazir'
        ),),
        SizedBox(height: 20,),
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                Text(food_data_section_one[0]['description'] ,style: TextStyle(fontFamily: 'Vazir'),),
